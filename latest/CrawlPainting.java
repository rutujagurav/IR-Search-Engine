...
public class CrawlPainting{
	...
	public static void main(String[] args) throws InterruptedException, IOException {
				...
				q3.addString("https://www.fizdi.com/full-collection/?sort=bestselling&page=102");
				
				//SaatchiCrawler saatchiThread = new SaatchiCrawler(q1);
				//saatchiThread.start();
				
				FizdiCrawler fizdiThread = new FizdiCrawler(q3,hashQ);
				fizdiThread.start();
				
				DeviantCrawler deviantThread = new DeviantCrawler(q2,hashQ);
				deviantThread.start();
